...
gulp.task('js-copy', function(){
   // require('./server.js');
   return gulp.src(['js/*.js'])//extension = js/css/pug
     .pipe(gulp.dest('dist/js'))
     .pipe(notify("js-copy task is done!"));
});
//*********my 11th task
//gulp.task('ready', ['copy-css', 'copy-js', 'create-polyfill-file']);
//*********my 7th task
...
gulp.task('watch', function(){
      ...
      gulp.watch('css/bootstrap- v3.3.7.css', gulp.series('css-copy'))
